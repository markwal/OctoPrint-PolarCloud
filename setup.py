...
plugin_version = "0.1.0Beta"
plugin_description = """Connects OctoPrint to the PolarCloud so you can easily
monitor and control outside of your local network"""
...
plugin_requires = ["SocketIO-client", "pyopenssl>=16.1", "Pillow"]
